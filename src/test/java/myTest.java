...
public class myTest {
    ...
    public static JsonElement getJson1() {
        ...
        try {
            FileReader fileReader = new FileReader("C:\\Users\\Raviraj\\Desktop\\JsonComparisonTask\\src\\main\\java\\jsonfiles\\actualJson.json");
    ...
    public static JsonElement getJson2() {
        ...
        JsonElement jsonElement=null;
        try {
            FileReader fileReader = new FileReader("C:\\Users\\Raviraj\\Desktop\\JsonComparisonTask\\src\\main\\java\\jsonfiles\\expectedJson.json");
            jsonElement = jsonParser.parse(fileReader);
        } catch (Exception e) {
            System.out.println("File not found");
        }
